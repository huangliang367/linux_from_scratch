...
BOARD_ARCH=arm64
BOARD_NAME=rk3568
CROSS_COMPILE=/home/hl/code/rk356x_linux/prebuilts/gcc/linux-x86/aarch64/gcc-linaro-6.3.1-2017.05-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-
...
cp tmp_its build/images/.tmp_its
...
/home/hl/code/rk356x_linux/rkbin/tools/mkimage -f build/images/.tmp_its  -E -p 0x800 build/images/boot.img
